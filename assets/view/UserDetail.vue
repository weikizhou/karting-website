              ...
              <div class="row mx-2">
                ...
                <div class="form-group-registration" :class="{ 'form-group--error': $v.email.$error }">
                  ...
                  <div class="form-input p-0" >
                    ...
                    <input type="email" v-model.trim="user.email" name="email" placeholder="E-mailadres">
                  </div>
                ...
                <div class="form-group-registration" :class="{ 'form-group--error': $v.name.$error }">
                  ...
                  <div class="form-input p-0">
                    ...
                    <input type="text" v-model.trim="user.name" name="name" placeholder="Volledige naam">
                  </div>
                ...
                <div class="form-group-registration" :class="{ 'form-group--error': $v.username.$error }">
                  ...
                  <div class="form-input p-0">
                    ...
                    <input type="text" v-model.trim="user.username" name="username" placeholder="Gebruikersnaam">
                  </div>
              ...
              <div class="row my-4 mx-2">
                ...
                <div class="form-group-registration" :class="{ 'form-group--error': $v.phone.$error }">
                  ...
                  <div class="form-input p-0">
                    ...
                    <input type="text" v-model.trim="user.phone" name="phone" placeholder="Telefoon">
                  </div>
                ...
                <div class="row p-0">
                  <div class="col-md-12 col-lg-8" :class="{ 'form-group--error': $v.postalCode.$error }">
                    ...
                    <div class="form-input p-0">
                      ...
                      <input id="postal_code" type="text" v-model.trim="user.postalCode" name="postal_code" placeholder="Postcode">
                    </div>
                  ...
                  <div class="col-md-12 col-lg-4 p-0" :class="{ 'form-group--error': $v.houseNr.$error }">
                    ...
                    <div class="form-input p-0">
                      ...
                      <input id="house_nr" type="text" v-model.trim="user.houseNr" name="house_nr" placeholder="Huis nr.">
                    </div>
                ...
                <div class="form-group-registration" :class="{ 'form-group--error': $v.address.$error }">
                  ...
                  <div class="form-input p-0">
                    ...
                    <input id="address" type="text" v-model="user.address" name="address" placeholder="Adres">
                  </div>
